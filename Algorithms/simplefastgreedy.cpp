#include "simplefastgreedy.h"

std::vector<procon::MoveState> SimpleFastGreedy::agentAct(){
    ...
    int target_index = std::distance(cum_sum.begin(), std::lower_bound(cum_sum.begin(), cum_sum.end(), rand_value));
