...
namespace procon::json{
    ...
    std::vector<int> getAgentIds(std::string json_str, int team_id);

    procon::Field importJsonToField(std::string path, int team_id, std::vector<int>& agent_ids, int end_turn);
}
