...
struct ConnectionSettings{
    ConnectionSettings(int match_id = 1, std::string ip = "192.168.0.16", int port = 8888, std::string token = "procon30_example_token", int team_id = 1, std::vector<int> agent_id = std::vector<int>{8, 6, 9, 120}) :
        match_id(match_id),
        port(port),
        team_id(team_id),
        agent_id(agent_id),
